...
import de.htw_berlin.database.models.type_converters.*;

import java.util.Arrays;

/**
 * Parses entity to string
 */
public final class EntityStringParser {
     ...
     */
    public static String objectToString(Entity object) {
     ...
     * @return string representing object
     */
    public static Entity objectFromString(String str) {
